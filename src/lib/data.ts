...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    en: {
      name: "Abdelkreem El-Behery",
      role: "Financial Systems & Accounts Reviewer",
      bio: "Senior consultant in financial systems and accounting review with extensive experience in governance, auditing controls, and institutional financial compliance.",
    },
    ar: {
      name: "عبدالكريم البحيري",
      role: "مراجع النظم المالية والحسابات",
      bio: "استشاري متخصص في مراجعة النظم المالية والحسابات بخبرة واسعة في الحوكمة والرقابة والامتثال المالي المؤسسي.",
    },
  },
  {
    id: "2",
    image: "/trainers/mo-khatab.png",
    en: {
      name: "Dr. Mohamed Khattab",
      role: "Food Safety Consultant",
      bio: "Specialist in food safety systems, HACCP implementation, and quality assurance practices for hospitality and food service operations.",
    },
    ar: {
      name: "دكتور محمد خطاب",
      role: "استشاري أمن وسلامة الغذاء",
 ...
 
  {
    ...
    en: { name: "Chef Jehad El-Deen Mohamed Ahmed", role: "Culinary & Kitchen Operations Trainer", bio: "A prominent culinary consultant with extensive experience in luxury hospitality kitchens. Combines culinary creativity with operational excellence in kitchen development, menu design, team leadership, and F&B quality standards." },
    ar: { name: "الشيف جهاد الدين محمد أحمد", role: "مدرب فنون الطهي وتشغيل المطابخ", bio: "أحد الكفاءات المهنية البارزة في فنون الطهي وإدارة تشغيل المطابخ الفندقية. يجمع بين الإبداع الطهوي والانضباط التشغيلي، ويساهم في تطوير البرامج التدريبية المتقدمة في الطهي وإدارة المطابخ الفندقية." },
  },
...
export const trainers: Trainer[] = [
  {
    ...
    courses: 8,
    countries: 5,
    specialties: ["Housekeeping Management", "Service Quality", "Hospitality Operations"],
    en: { name: "Mohamed Ali Abdel Tawab", role: "Hospitality Trainer - AIAETAR", bio: "Highly experienced hospitality professional with over 20 years of expertise in local and international hotel operations. Specialized in housekeeping management and service quality standards." },
    ar: { name: "محمد علي عبدالتواب", role: "مدرب ضيافة - المعهد الأمريكي", bio: "خبير ضيافة بخبرة تتجاوز 20 عاماً في عمليات الفنادق محلياً ودولياً، ومتخصص في إدارة التدبير الفندقي ومعايير جودة الخدمة." },
  },
  // {
  //   id: "3",
  //   image: "/trainers/evon-saber.png",
  //   rating: 4.7,
  //   courses: 5,
  //   countries: 4,
  //   specialties: ["Hospitality Service", "Front Office", "Communication Skills"],
  //   en: { name: "Evon Saber", role: "Hospitality Service Trainer", bio: "Professional trainer focused on hospitality service quality, guest communication, and front-office excellence within applied training environments." },
  //   ar: { name: "إيفون صابر", role: "مدربة خدمات الضيافة", bio: "مدربة متخصصة في جودة خدمات الضيافة والتواصل مع الضيوف وتميز العمل الأمامي ضمن بيئات التدريب التطبيقي." },
  // },
  {
    id: "4",
    image: "/trainers/rania-fouad.png",
    rating: 4.8,
    courses: 6,
    countries: 3,
    specialties: ["Executive Leadership", "Business Administration", "HR Development"],
    en: { name: "Rania Fouad Farag", role: "Executive Director & Management Trainer", bio: "Doctor of Business Administration with academic and practical background in business administration and human development. Specialised in leadership, institutional management, and people development." },
    ar: { name: "رانيا فؤاد فرج", role: "مديرة تنفيذية ومدربة إدارة", bio: "دكتوراه في اداره الموارد البشريه، مديرة تنفيذية بخلفية أكاديمية وعملية في إدارة الأعمال وتنمية الموارد البشرية، متخصصة في القيادة المؤسسية وتطوير الكفاءات." },
  },
  {
    id: "5",
    image: "/trainers/yasser-mohamed.png",
    rating: 4.7,
    courses: 5,
    countries: 2,
    specialties: ["Tourism Operations", "Guest Service", "Field Supervision"],
    en: { name: "Yasser Mohamed Afifi Mohamed", role: "Tourism Operations Trainer", bio: "Tourism division professional with field experience in operational follow-up, service coordination, and tourism workflow execution." },
    ar: { name: "ياسر محمد عفيفي محمد", role: "مدرب عمليات سياحية", bio: "متخصص في قطاع السياحة بخبرة عملية في المتابعة التشغيلية وتنسيق الخدمات وتنفيذ إجراءات العمل الميداني." },
  },
];
