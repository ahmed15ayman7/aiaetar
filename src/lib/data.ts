...
export const trainers: Trainer[] = [
  ...
  },
  {
    ...
    en: { name: "Rania Fouad Farag", role: "Executive Director & Management Trainer", bio: "Executive Director with academic and practical background in business administration and human development. Specialised in leadership, institutional management, and people development." },
    ar: { name: "رانيا فؤاد فرج", role: "مديرة تنفيذية ومدربة إدارة", bio: "مديرة تنفيذية بخلفية أكاديمية وعملية في إدارة الأعمال وتنمية الموارد البشرية، متخصصة في القيادة المؤسسية وتطوير الكفاءات." },
  },
  // {
  //   id: "5",
